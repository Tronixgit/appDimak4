...
namespace appDimak.Models
{
    public partial class NorthwindContext : DbContext
    {
        ...
        public virtual DbSet<IntentosModificacion> IntentosModificacions { get; set; } = null!;
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<CustomerCustomerDemo>(entity =>
            {
                ...
                entity.HasOne(d => d.Customer)
                    .WithOne(p => p.CustomerCustomerDemo)
            ...
            modelBuilder.Entity<Employee>(entity =>
            {
                ...
                entity.HasMany(d => d.Idpermisos)
                    ...
                    .UsingEntity<Dictionary<string, object>>(
                        "PermisosByUsuario",
                        l => l.HasOne<Permiso>().WithMany().HasForeignKey("Idpermiso").OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("FK__PermisosB__IDPer__74AE54BC"),
                        r => r.HasOne<Employee>().WithMany().HasPrincipalKey("Email").HasForeignKey("Email").OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("FK__PermisosB__Email__73BA3083"),
                        j =>
                        {
                            ...
                            j.IndexerProperty<int>("Idpermiso").ValueGeneratedOnAdd().HasColumnName("IDPermiso");
                        });
            ...
            modelBuilder.Entity<IntentosModificacion>(entity =>
            {
                entity.ToTable("IntentosModificacion");

                entity.Property(e => e.Id).HasColumnName("ID");

                entity.Property(e => e.AttemptedModificationDate).HasColumnType("datetime");

                entity.Property(e => e.AttemptedNewPrice).HasColumnType("money");

                entity.Property(e => e.OldUnitPrice).HasColumnType("money");
            ...
            modelBuilder.Entity<Permiso>(entity =>
            {
                entity.HasKey(e => e.Idpermiso)
                    .HasName("PK__Permiso__F11D75F370C226B3");
